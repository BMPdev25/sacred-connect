...
type BookingConfirmationRoute = RouteProp<Record<string, object | undefined>, string> & {
  params: { booking: any };
};

const BookingConfirmationScreen: React.FC<{ navigation: any; route: BookingConfirmationRoute }> = ({ navigation, route }) => {
