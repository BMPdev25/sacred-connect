...
const HomeScreen: React.FC = () => {
    ...
    const loadDashboardData = async () => {
      try {
        ...
        try {
          ...
          setUpcomingBookings(
            (bookingsData && bookingsData.slice
              ? bookingsData.slice(0, 3)
              : bookingsData) || []
          );
        } catch (err) {
  ...
  const handleCeremonyPress = (ceremony: any) => {
    router.push("/AvailableOffers" ) //as any, { ceremony });
  };
        ...
        >
          ...
          <View style={styles.upcomingBookingsContainer}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity onPress={() => router.push("/priest/BookingsTab")}>
                ...
                <View style={styles.upcomingBookingContent}>
                  ...
                  <View style={{ flex: 1, flexWrap: "wrap" }}>
                    <Text
                      ...
                      ellipsizeMode="tail"
                    >
                      {booking.ceremonyType || booking.ceremony} for{" "}
                      {booking.devoteeId?.name || booking.devotee} on{" "}
