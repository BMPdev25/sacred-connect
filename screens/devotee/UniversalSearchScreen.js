...
const UniversalSearchScreen = ({ navigation }) => {
    ...
    >
      ...
      <View style={styles.itemContent}>
        ...
        <View style={styles.ratingContainer}>
          <Ionicons name="star" size={16} color={APP_COLORS.warning} />
  ...
  const renderSuggestion = ({ item }) => (
    ...
    >
      <Ionicons
        name={item.type === 'priest' ? 'person-outline' : 'star-outline'}
        size={20}
    ...
    <View style={styles.container}>
      ...
      {showSuggestions && suggestions.length > 0 ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => 
            item.type === 'priest' ? renderPriestItem({ item }) : renderCeremonyItem({ item })
          }
          ...
          ListEmptyComponent={() => (
            query.length > 0 && !isLoading && (
              <View style={styles.emptyContainer}>
                <Ionicons name="search" size={48} color={APP_COLORS.lightGray} />
